...
const mockDatasets: Dataset[] = [
    {
        ...
        description: 'A curated subset of ImageNet containing 10,000 high-quality labeled images across 100 categories. Perfect for transfer learning and model fine-tuning.',
    ...
    },
    {
        ...
        description: 'Anonymized chest X-ray images with radiologist annotations. Includes normal and abnormal findings for AI-assisted diagnosis research.',
        category: 'Biomedical',
    ...
    },
    {
        ...
        description: 'Parallel text corpus covering 50 languages with sentence-level alignment. Ideal for machine translation and multilingual NLP research.',
    ...
    },
    {
        ...
        description: 'High-quality speech recordings with transcriptions across multiple accents and speaking styles. Includes noise-augmented versions.',
        category: 'Audio',
    ...
    },
    {
        ...
        description: 'Curated protein structures with experimental validation. Formatted for direct use with AlphaFold and other structure prediction models.',
        category: 'Biomedical',
    ...
    },
    {
        ...
        description: 'High-resolution LiDAR scans from urban driving scenarios with 3D bounding box annotations for vehicles, pedestrians, and cyclists.',
        category: 'Computer Vision',
                    ...
                    <div className="flex flex-col sm:flex-row gap-4">
                        ...
                        <div className="relative">
                            <select
                                ...
                                className="appearance-none w-full sm:w-48 px-4 py-3 bg-gray-800 border border-gray-700 rounded-xl text-white focus:outline-none focus:border-purple-500 pr-10"
                            >
                                {categories.map((cat) => (
                        ...
                        <div className="relative">
                            <select
                                ...
                                className="appearance-none w-full sm:w-44 px-4 py-3 bg-gray-800 border border-gray-700 rounded-xl text-white focus:outline-none focus:border-purple-500 pr-10"
                            >
                                {sortOptions.map((opt) => (
